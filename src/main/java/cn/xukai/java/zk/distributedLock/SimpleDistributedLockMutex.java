 ...
 */
public class SimpleDistributedLockMutex extends BaseDistributedLock implements DistributedLock ,Callable<Boolean> {
    Logger logger = Logger.getLogger(SimpleDistributedLockMutex.class);
     /*
